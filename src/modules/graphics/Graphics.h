...
public:
	 ...
	 *
	 * It's like transformPoint, but 3D.
	*/
	void project(const Vector3 &worldSpacePoint, Vector3 &result);

	/**
	 * Unprojects a 3-dimensional point in screen-space to world space.
	 *
	 * It's like inverseTransformPoint, but 3D.
	**/
	void unproject(const Vector3 &screenSpacePoint, Vector3 &result);
