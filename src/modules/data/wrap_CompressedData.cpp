...
extern "C" int luaopen_compresseddata(lua_State *L)
{
	...
	love::data::luax_rundatawrapper(L, CompressedData::type);return luax_register_type(L, &CompressedData::type, w_Data_functions, w_CompressedData_functions, nullptr);
	return ret;
}
